...
public class BiomesBase {
    ...
    public BiomesBase() {
        field_4242_o = (byte) GenerateChunk.Blocks.GRASS.getValue();
        field_4241_p = (byte) GenerateChunk.Blocks.DIRT.getValue();
    ...
    public static void func_4120_a() {
        ...
        Desert.field_4242_o = Desert.field_4241_p = (byte) GenerateChunk.Blocks.SAND.getValue();
        field_4247_j.field_4242_o = field_4247_j.field_4241_p = (byte)GenerateChunk.Blocks.SAND.getValue();
    }
    ...
    public static final BiomesBase field_4247_j = (new BiomesBase()).func_4123_b(0xffed93).func_4125_a("Ice Desert").func_4122_b().func_4124_a(0xc4d339);
    ...
    public static final BiomesBase field_4245_l = (new BiomesBase()).func_4123_b(0xff0000).func_4125_a("Hell");
