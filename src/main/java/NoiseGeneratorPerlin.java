...
public class NoiseGeneratorPerlin extends NoiseGenerator {
    ...
    public void generatePermutations(double[] ad, double d, double d1, double d2, int i, int j, int k, double d3, double d4, double d5, double d6) {
        if (j == 1) {
            int j3 = 0;
            double d12 = 1.0D / d6;
            for (int i4 = 0; i4 < i; i4++) {
                double d14 = (d + (double) i4) * d3 + xCoord_03;
                int j4 = (int) d14;
                if (d14 < (double) j4) {
                    j4--;
                }
                ...
                for (int l4 = 0; l4 < k; l4++) {
                    double d19 = (d2 + (double) l4) * d5 + zCoord_03;
                    int j5 = (int) d19;
                    if (d19 < (double) j5) {
                        j5--;
                    }
        ...
        for (int i5 = 0; i5 < i; i5++) {
            double d20 = (d + (double) i5) * d3 + xCoord_03;
            int k5 = (int) d20;
            if (d20 < (double) k5) {
                k5--;
            }
            ...
            for (int j6 = 0; j6 < k; j6++) {
                double d24 = (d2 + (double) j6) * d5 + zCoord_03;
                int k6 = (int) d24;
                if (d24 < (double) k6) {
                    k6--;
                }
                ...
                for (int i7 = 0; i7 < j; i7++) {
                    double d26 = (d1 + (double) i7) * d4 + yCoord_03;
                    int j7 = (int) d26;
                    if (d26 < (double) j7) {
                        j7--;
                    }
