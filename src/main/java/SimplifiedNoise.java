...
public class SimplifiedNoise {
    ...
    public void noise(double[] ad, double d, double d1, int i, int j,
                      double d2, double d3, double d4) {
        int k = 0;
        for (int l = 0; l < i; l++) {
            double d5 = (d + (double) l) * d2 + xo;
            for (int i1 = 0; i1 < j; i1++) {
                double d6 = (d1 + (double) i1) * d3 + yo;
                ...
                int k2 = k1 & 0xff;
                int l2 = p[j2 + p[k2]] % 12;
                int i3 = p[j2 + l1 + p[k2 + i2]] % 12;
                int j3 = p[j2 + 1 + p[k2 + 1]] % 12;
