...
public class SimplifiedNoiseOctaves extends NoiseGenerator {
    ...
    public double[] generateNoise(double[] ad, double d, double d1, int i, int j, double d2, double d3, double d4) {
        return generateOctaves(ad, d, d1, i, j, d2, d3, d4, 0.5D);
    }

    public double[] generateOctaves(double[] ad, double d, double d1, int i, int j, double d2, double d3, double d4, double d5) {
        d2 /= 1.5D;
        d3 /= 1.5D;
